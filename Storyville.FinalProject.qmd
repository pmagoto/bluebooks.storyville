...
addresses.1900 <- read.csv("/Users/paigemagoto/Desktop/bluebooks.storyville/CSVs/people.1900.geocoded.csv")
addresses.1915 <- read.csv("/Users/paigemagoto/Desktop/bluebooks.storyville/CSVs/people.1915.geocoded.csv")
```
...
SVwithTrainStation <- ggmap(statictrain) + #load static map at zoom 16
  ...
  geom_polygon(data = lonlattrain, aes(x=longitudetrain, y=latitudetrain),alpha = 0.1, color = "blue", fill = "blue") + #how do i make this a circle so its obvious? 
