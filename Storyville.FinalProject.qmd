...
Below is an interactive map categorized by businesses and years, this shows specifically the buisineses name, those employed by the business, and racial identification of the business, as they are listed in the books. Takign direct influence from the Mapping the Gay guides Project, I'd like to see the
