...
addresses.1900 <- read.csv("CSVs/addresses.1900.geocoded.csv")
addresses.1915 <- read.csv("CSVs/addresses.1915.geocoded.csv")
...
test.addresses.1915 <- read.csv("CSVs/addresses.1915.geocoded.csv") %>% rename("people.id"="id.sexworkers") %>% separate_rows(people.id, convert = TRUE) %>% distinct(address.id, .keep_all = TRUE)
