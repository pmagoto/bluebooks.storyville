...
BSVandWSVstatic <-  get_map(location = centerofBSVandSV, zoom = 16, maptype = "satellite", color = "bw") #create static map
...
: As shown above, this proposed city ordinance, that Storyville did not live long enough to see through was incredibly impractical. The

\[\[\[density of race\]\]\]

## Argument:

There was inherent segregation within the district, that was catering to illicit "interracial" sex between a white man and a woman of color. While not the only
